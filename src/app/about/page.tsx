...
export default function About() {
  return (
    <div className="min-h-screen bg-green-900 text-white p-6 flex flex-col items-center">
      ...
      {/* HEADER */}
      <Image src="/logo.png" width={120} height={120} alt="Logo" className="mb-6 rounded-full shadow-lg" />
      ...
      <div className="w-full max-w-2xl bg-white text-gray-800 rounded-xl p-8 shadow-2xl space-y-6">
        ...
        <section className="border-t border-gray-200 pt-6 mt-6">
          <h3 className="text-lg font-bold text-gray-700 mb-1">Credits</h3>
          <p><strong>Created By:</strong> Robb Helt</p>
          <p className="text-sm text-gray-500 mt-1">Copyright: © 2025 Robb Helt. All Rights Reserved.</p>
        </section>
